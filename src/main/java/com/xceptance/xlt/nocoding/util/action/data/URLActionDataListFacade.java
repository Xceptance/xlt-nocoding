...
public class URLActionDataListFacade
{
    ...
    private YAMLBasedURLActionDataListBuilder createYAMLBuilder()
    {
        ...
        final YAMLBasedURLActionDataListBuilder yamlBuilder = new YAMLBasedURLActionDataListBuilder(filePath, interpreter, actionBuilder,
    ...
    private CSVBasedURLActionDataListBuilder createCSVBuilder()
    {
        ...
        final CSVBasedURLActionDataListBuilder csvBuilder = new CSVBasedURLActionDataListBuilder(filePath, interpreter, actionBuilder);
        return csvBuilder;
    }
}
