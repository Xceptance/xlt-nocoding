...
public final class ParameterUtils
{
    ...
    public static void isArrayListMessage(final Object o, final String name, final String... messages)
    {
        ...
        {
            doThrowMessages(name, Reason.NOT_ARRAYLIST, messages);
        }
    }
    ...
    {
        NULL, EMPTY, NEGATIVE, UNREADABLE("an unreadable file"), UNWRITABLE("an unwritable file"), ABSOLUTE("an absolute path"), LESS(
            "less than"), GREATER("greater than"), NOT_ARRAY("not an array"), NOT_ARRAYLIST("not an array list"), NOT_LINKEDHASHMAP(
                "not a linked hash map"), NOT_DIRECTORY("not a directory"), NON_EXISTENT(
                    "non-existent"), NOT_FILE("not a file"), UNACCESSIBLE("an unaccessible file"), STRING("not a String"), INTEGER(
                        "not an Integer"), UNSUPPORTED_TYPE(
