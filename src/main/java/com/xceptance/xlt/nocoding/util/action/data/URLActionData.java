...
public class URLActionData
{
     ...
     * </p>
     */
    public final static Set<String> PERMITTEDTYPES = new HashSet<>();
     ...
     * <ul>
     */
    public final static Set<String> PERMITTEDMETHODS = new HashSet<>();
    ...
    public void setEncodeParameters(final String encoded)
    {
        if (encoded != null)
        {
            ...
            XltLogger.runTimeLogger.debug(getSetTagToValueMessage("encodedParameters", encodeParameters));
        }
    }
    ...
    public void setEncodeParameters(final Boolean encoded)
    {
        if (encoded != null)
        {
            encodeParameters = encoded.toString();
            XltLogger.runTimeLogger.debug(getSetTagToValueMessage("encodedParameters", encodeParameters));
        }
    }
    ...
    public void setEncodeBody(final String encoded)
    {
        ...
        {
            encodeBody = encoded;
            XltLogger.runTimeLogger.debug(getSetTagToValueMessage("encodedBody", encodeBody));
        }
    }
    ...
    {
        return interpreter.processDynamicData(body);
    }
    ...
    {
        final String dynmaicResponseCode = interpreter.processDynamicData(httpResponceCode);
    ...
    public HttpMethod getMethod()
    {
        ...
        final String dynamicMethod = interpreter.processDynamicData(method);
    ...
    {
        final List<NameValuePair> result = new ArrayList<>(parameters.size());
    ...
    {
        final List<NameValuePair> result = new ArrayList<>(cookies.size());
    ...
    {
        final List<NameValuePair> result = new ArrayList<>(headers.size());
    ...
    public Boolean encodeParameters()
    {
        ...
        final String dynamicEncoded = interpreter.processDynamicData(encodeParameters);
    ...
    public Boolean encodeBody()
    {
        ...
        if (encodeBody != null)
        {
            final String dynamicEncoded = interpreter.processDynamicData(encodeBody);
            if ("true".equals(dynamicEncoded))
            {
                result = true;
            }
    ...
    {
        Boolean result = false; // default
        final String dynamicType = interpreter.processDynamicData(type);
    ...
    {
        final String message = MessageFormat.format("Action: \"{0}\", Set \"{1}\" to value: \"{2}\"", name, tag, value);
        return message;
    }
    ...
    {
        final String message = MessageFormat.format("Action: \"{0}\", Added new \"{1}\"", name, tag);
        return message;
    }
    ...
    {
        final String message = MessageFormat.format("Action: \"{0}\", Set new \"{1}\"", name, tag);
        return message;
    }
