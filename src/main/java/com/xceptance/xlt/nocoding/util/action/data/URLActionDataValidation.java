...
public class URLActionDataValidation
{
    ...
    {
        final String message = MessageFormat.format("Validation: \"{0}\", Set \"{1}\" to value: \"{2}\"", name, tag, value);
        return message;
    }
    ...
    {
        final String message = MessageFormat.format("Validation: \"{0}\", Set new \"{1}\"", name, tag);
        return message;
    }
    ...
    {
        final String message = MessageFormat.format("Validation: \"{0}\", Illegal value: \"{1}\" for tag \"{2}\"", name, value, tag);
        return message;
    }
    ...
    {
        final String message = MessageFormat.format("Validation: \"{0}\", tag \"{1}\"  cannot be NULL", name, tag);
        return message;
    }
}
