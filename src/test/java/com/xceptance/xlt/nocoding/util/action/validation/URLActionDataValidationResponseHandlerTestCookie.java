...
public class URLActionDataValidationResponseHandlerTestCookie
{
    ...
    public static void setup()
    {
        ...
        validationCookieTextMalicious = new URLActionDataValidation("text_malicious", URLActionDataValidation.COOKIE,
                                                                    mockObjects.cookieName2, URLActionDataValidation.TEXT,
                                                                    "something stupid", interpreter);
        ...
        validationCookieMatchesMalicious = new URLActionDataValidation("matches_malicious", URLActionDataValidation.COOKIE,
                                                                       mockObjects.cookieName2, URLActionDataValidation.MATCHES, "bla",
                                                                       interpreter);
        ...
        validationCookieCountMalicious = new URLActionDataValidation("count_malicious", URLActionDataValidation.COOKIE,
                                                                     mockObjects.cookieName1, URLActionDataValidation.COUNT, "2",
                                                                     interpreter);
