...
public class URLActionDataValidationResponseHandlerTest
{
    ...
    public static void setup()
    {
        ...
        validationCount = new URLActionDataValidation("count", URLActionDataValidation.REGEXP, mockObjects.regexString,
                                                      URLActionDataValidation.COUNT, "1", interpreter);
        validationText = new URLActionDataValidation("text", URLActionDataValidation.REGEXP, mockObjects.regexString,
                                                     URLActionDataValidation.TEXT, mockObjects.regexStringExpected, interpreter);
