...
public class URLActionDataRequestBuilderTest
{
    ...
    private final List<NameValuePair> parametersEmpty = new ArrayList<>();

    private final List<NameValuePair> parametersDecoded = new ArrayList<>();

    private final List<NameValuePair> parametersEncoded = new ArrayList<>();
