...
public class URLActionDataListBuilderTest
{
    ...
    {
        final DummyBuilder builder = new DummyBuilder("doesnotexist.txt",
                                                      new ParameterInterpreter(XltProperties.getInstance(),
    ...
    {
        final DummyBuilder builder1 = new DummyBuilder("doesnotexist1.txt",
                                                       new ParameterInterpreter(XltProperties.getInstance(),
                                                                                GeneralDataProvider.getInstance()),
                                                       new URLActionDataBuilder());

        final DummyBuilder builder2 = new DummyBuilder("doesnotexist1.txt",
                                                       new ParameterInterpreter(XltProperties.getInstance(),
                                                                                GeneralDataProvider.getInstance()),
                                                       new URLActionDataBuilder());
    ...
    private static class DummyBuilder extends URLActionDataListBuilder
    {
        ...
        public DummyBuilder(final String filePath, final ParameterInterpreter interpreter, final URLActionDataBuilder actionBuilder)
        {
        ...
        public List<URLActionData> buildURLActionDataList()
        {
            ...
            try
            {
                ...
                actionBuilder.setUrl((String) o);
                actionBuilder.setName("TEST");
                actionBuilder.setInterpreter(interpreter);
                return Arrays.asList(actionBuilder.build());
            }
